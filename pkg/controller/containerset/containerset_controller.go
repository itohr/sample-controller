...
import (
	...
	workloadsv1beta1 "github.com/itohr/sample-controller/pkg/apis/workloads/v1beta1"
...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this workloads.Add(mgr) to install this Controller
...
// +kubebuilder:rbac:groups=workloads.sample.k8s.io,resources=containersets,verbs=get;list;watch;create;update;patch;delete
